...
const HeroSection = () => {
  return (
    <section className="min-h-screen flex items-center justify-center bg-background px-6 py-32">
      <div className="container mx-auto max-w-5xl">
        <div className="text-center">
          <h1 className="text-6xl lg:text-8xl font-bold mb-8 leading-[0.9] tracking-tight text-foreground">
            <span className="text-foreground">Rabbit AI:</span><br />
            The Future of <span className="text-foreground">Hiring</span> Is Here
          </h1>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 mt-24">
            <div className="text-center">
              <div className="text-5xl lg:text-6xl font-bold text-foreground mb-2">80%</div>
              <div className="text-lg text-muted-foreground font-medium">Faster Hiring</div>
            </div>
            <div className="text-center">
              <div className="text-5xl lg:text-6xl font-bold text-foreground mb-2">60%</div>
              <div className="text-lg text-muted-foreground font-medium">Cost Reduction</div>
            </div>
            <div className="text-center">
              <div className="text-5xl lg:text-6xl font-bold text-foreground mb-2">24x7</div>
              <div className="text-lg text-muted-foreground font-medium">Availability</div>
            </div>
            <div className="text-center">
              <div className="text-5xl lg:text-6xl font-bold text-foreground mb-2">120+</div>
